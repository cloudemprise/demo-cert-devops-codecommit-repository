...
# demo-cert-devops-codecommit-repository-sync-git-repos.sh
...
PROJECT_NAME="demo-cert-devops-codecommit-repository"
while true
do
  # -e : stdin from terminal
  # -r : backslash not an escape character
...
REPO_DESCRIPTION=\
"AWS CodeCommit / GitHub Repository used for the Hands-On Demonstrations in \
connection with the AWS Certified DevOps Engineer Professional Exam Study course."
while true
do
  # -e : stdin from terminal
  # -r : backslash not an escape character
